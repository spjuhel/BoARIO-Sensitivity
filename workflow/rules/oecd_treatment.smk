...
rule extract_oecd2021_2000_2004:
    ...
    output:
        expand("mrio-files/csvs/oecd_v2021/ICIO2021_{years}.csv",years=[2000,2001,2002,2003,2004])
    log:
...
rule extract_oecd2021_1995_1999:
    ...
    params:
        folder = "mrio-files/csvs/oecd_v2021/"
    output:
        expand("mrio-files/csvs/oecd_v2021/ICIO2021_{years}.csv", years=[1995,1996,1997,1998,1999])
    log:
...
rule extract_oecd2021_2005_2009:
    ...
    params:
        folder = "mrio-files/csvs/oecd_v2021/"
    output:
        expand("mrio-files/csvs/oecd_v2021/ICIO2021_{years}.csv", years=[2005,2006,2007,2008,2009])
    log:
...
rule extract_oecd2021_2010_2014:
    ...
    params:
        folder = "mrio-files/csvs/oecd_v2021/"
    output:
        expand("mrio-files/csvs/oecd_v2021/ICIO2021_{years}.csv", years=[2010,2011,2012,2013,2014])
    log:
...
rule extract_oecd2021_2015_2018:
    ...
    params:
        folder = "mrio-files/csvs/oecd_v2021/"
    output:
        expand("mrio-files/csvs/oecd_v2021/ICIO2021_{years}.csv", years=[2015,2016,2017,2018])
    log:
...
rule download_extract_oecd2021:
    input:
        zipfile = HTTPS.remote("stats.oecd.org/wbos/fileview2.aspx", keep_local=True,  additional_request_string="?IDFile=8adf89dd-18b4-40fe-bc7f-c822052eb961")
    params:
        folder = "autodownloads/oecd/"
    output:
        expand("autodownloads/oecd/ICIO2021_{years}.csv",years=[2000,2001,2002,2003,2004])
    log:
