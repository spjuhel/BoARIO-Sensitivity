...
rule download_extract_euregio:
    input:
        first=HTTPS.remote(
            "dataportaal.pbl.nl/downloads/PBL_Euregio/PBL-EUREGIO-2000-2005-ODS.zip",
            keep_local=True,
        ),
        second=HTTPS.remote(
            "dataportaal.pbl.nl/downloads/PBL_Euregio/PBL-EUREGIO-2006-2010-ODS.zip",
            keep_local=True,
        ),
    params:
        folder="autodownloads/euregio/",
    output:
        expand(
            "autodownloads/euregio/EURegionalIOtable_{years}.ods",
